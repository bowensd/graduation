...
public class RedisUtil {
    ...
    public RedisUtil(String address, int port, String pwd, int timeout, int maxActive, int maxWait, int maxIdle, int minIdle) {
        ...
        if(null == pwd || pwd.length() == 0) {
            ...
            jedisPool = new JedisPool(config, address, port, timeout, pwd);
        }
